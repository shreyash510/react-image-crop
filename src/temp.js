  ...
  setRatioToBottomLeft = ({
    ...
    if (original.x + (newMouseX - original.mouse_x) >= 0) {
      ...
      if (
        ...
        this.setState({ final: updatedFinal });
      } else if (newHeight + final.y >= this.parentHeight) {
  ...
  move = (e) => {
    ...
    if (this.state.isMoveDiv) {
      ...
      if (
        ...
        this.setState({ final: updatedFinal });
      } else if (newMouseY + offset[1] + final.height >= this.parentHeight) {
      ...
      if (
        ...
        this.setState({ final: updatedFinal });
      } else if (newMouseX + offset[0] + final.width >= this.parentWidth) {
